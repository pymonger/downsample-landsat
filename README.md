...
1. Verify that the `LC08_L1TP_065016_20130724_20170309_01_T1_BQA.TIF` image file was created:
   ...
   Output should look similar to this:
   ``` 
   -rw-r--r--  1 pymonger  wheel  1997366 Mar  2 12:56 LC08_L1TP_065016_20130724_20170309_01_T1_BQA.TIF
   ```
...
1. Run cwltool (to run singularity instead of docker, add `--singularity` option):
   ...
   INFO [job downsample_landsat.cwl] /private/tmp/docker_tmpr5ebt491$ docker \
       ...
       --mount=type=bind,source=/Users/pymonger/dev/downsample-landsat/LC08_L1TP_065016_20130724_20170309_01_T1_BQA.TIF,target=/tpDYGB/LC08_L1TP_065016_20130724_20170309_01_T1_BQA.TIF,readonly \
       --workdir=/tpDYGB \
       --net=none \
       --log-driver=none \
       --rm \
       ...
       /bin/sh \
       -c \
       papermill /home/jovyan/downsample-landsat/downsample_landsat.ipynb output_nb.ipynb --parameters input_file "LC08_L1TP_065016_20130724_20170309_01_T1_BQA.TIF" --parameters min_spin_time "20" --parameters max_spin_time "40" > /private/tmp/docker_tmpr5ebt491/downsample_landsat-stdout.txt 2> /private/tmp/docker_tmpr5ebt491/downsample_landsat-stderr.txt
...
1. Verify that the `LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled` dataset directory was created:
   ...
   ``` 
   total 160
   -rw-r--r--  1 pymonger  wheel  20777 Mar  2 13:01 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.TIF
   -rw-r--r--  1 pymonger  wheel  50629 Mar  2 13:01 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.browse.png
   -rw-r--r--  1 pymonger  wheel   3116 Mar  2 13:01 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.met.json
   ```
...
1. Run cwltool (to run singularity instead of docker, add `--singularity` option):
   ...
   INFO [job stage_out.cwl] /private/tmp/docker_tmpqzxwnh2u$ docker \
       ...
       --mount=type=bind,source=/Users/pymonger/dev/downsample-landsat/LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled,target=/var/lib/cwl/stg3401acae-259c-499b-8f12-16681fa3541c/LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled,readonly \
       --workdir=/rgrrqW \
       --read-only=true \
       --log-driver=none \
       --user=503:20 \
...
1. Verify that the`LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled` dataset directory was staged to the 
   ...
   Output should look similar to this:
   ```
   2022-02-18 16:25:52      20777 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.TIF
   2022-02-18 16:25:52      49848 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.browse.png
   2022-02-18 16:25:52       3008 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.met.json
   ```
...
1. Run cwltool (to run singularity instead of docker, add `--singularity` option):
   ...
   INFO [job downsample_landsat] /private/tmp/docker_tmpuxqihtw3$ docker \
       ...
       --mount=type=bind,source=/private/tmp/docker_tmp1p7p0v4a/LC08_L1TP_065016_20130724_20170309_01_T1_BQA.TIF,target=/sFjOOZ/LC08_L1TP_065016_20130724_20170309_01_T1_BQA.TIF,readonly \
       --workdir=/sFjOOZ \
       --net=none \
       --log-driver=none \
       --rm \
       ...
       /bin/sh \
       -c \
       papermill /home/jovyan/downsample-landsat/downsample_landsat.ipynb output_nb.ipynb --parameters input_file "LC08_L1TP_065016_20130724_20170309_01_T1_BQA.TIF" --parameters min_spin_time "15" --parameters max_spin_time "30" > /private/tmp/docker_tmpuxqihtw3/downsample_landsat-stdout.txt 2> /private/tmp/docker_tmpuxqihtw3/downsample_landsat-stderr.txt
   ...
   INFO [job stage_out] /private/tmp/docker_tmp6awts2g8$ docker \
       ...
       --mount=type=bind,source=/private/tmp/docker_tmpuxqihtw3/LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled,target=/var/lib/cwl/stgd93000df-dfa3-494a-884f-22232ee34400/LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled,readonly \
       --workdir=/sFjOOZ \
       --log-driver=none \
       --rm \
       ...
       sh \
       -c \
       'if [ ! -d $HOME/.aws ]; then cp -rp .aws $HOME/; fi && aws s3 cp --recursive /var/lib/cwl/stgd93000df-dfa3-494a-884f-22232ee34400/LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled s3://hysds-dataset-bucket-gman-test/docker_on_desktop_k8s/LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled' > /private/tmp/docker_tmp6awts2g8/stage_out-stdout.txt 2> /private/tmp/docker_tmp6awts2g8/stage_out-stderr.txt
...
1. Verify that the `LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled` dataset directory exists locally:
   ...
   ```
   total 160
   -rw-r--r--  1 pymonger  wheel  20777 Mar  2 13:11 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.TIF
   -rw-r--r--  1 pymonger  wheel  50629 Mar  2 13:11 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.browse.png
   -rw-r--r--  1 pymonger  wheel   3116 Mar  2 13:11 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.met.json
   ```
   ...
   Output should look similar to this:
   ```
   2022-02-18 16:34:47      20777 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.TIF
   2022-02-18 16:34:47      49848 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.browse.png
   2022-02-18 16:34:47       3008 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.met.json
   ```
...
1. Verify that the`LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled` dataset directory exists in the output-data directory:
   ...
   ```
   total 160
   -rw-r--r--  1 pymonger  staff  20777 Feb 18 18:03 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.TIF
   -rw-r--r--  1 pymonger  staff   3008 Feb 18 18:03 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.met.json
   -rw-r--r--  1 pymonger  staff  49848 Feb 18 18:03 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.browse.png
   ```
   ...
   Output should look similar to this:
   ```
   2022-02-18 16:46:44      20777 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.TIF
   2022-02-18 16:46:44      49848 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.browse.png
   2022-02-18 16:46:44       3008 LC08_L1TP_065016_20130724_20170309_01_T1_BQA_downsampled.met.json
   ```
